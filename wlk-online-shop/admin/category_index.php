                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Auto Fill <span class="btn btn-primary" data-toggle="modal" data-target="#categoryModal">Create New Category</span></h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($categories as $category){ ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="category_edit.php?id=<?= $category->id ?>" class="btn btn-sm btn-success">Edit</a>
                                                                <a href="../_actions/category_delete.php?id=<?= $category->id ?>" class="btn btn-sm btn-danger">Delete</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
