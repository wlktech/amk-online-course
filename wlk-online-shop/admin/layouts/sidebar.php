...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="dashboard.php"><i class="la la-home"></i><span class="menu-title" data-i18n="eCommerce Dashboard">eCommerce Dashboard</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-server"></i><span class="menu-title" data-i18n="Components">User Management</span></a>
                    <ul class="menu-content">
                        <?php if($auth->value==1){ ?>
                        <li><a class="menu-item" href="user_index.php"><i></i><span data-i18n="Alerts"><i class="la la-list"></i>User Lists</span></a>
                        </li>
                        <?php } ?>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-unlock"></i><span class="menu-title" data-i18n="Authentication">Product Management</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="category_index.php"><i></i><span>Product Category</span></a></li>
                        <li><a class="menu-item" href="product_index.php"><i></i><span>Shop Product</span></a></li>
                    </ul>
                </li>
