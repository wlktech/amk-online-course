...
if (isset($_SESSION['cart'])) {
  ...
  <?php 
   include('includes/order_index_head.php');
   ?>
              ...
              <form class="needs-validation" novalidate="" action="_actions/order_create.php" method="post">
               ...
               <div class="row">
                <div class="col-md-3 mb-3">
                 ...
                 <input type="date" name="exp_date" class="form-control" id="cc-expiration" placeholder="" required="" />
                 <div class="invalid-feedback">
...
<?php include "includes/order_script.php" ?>    
