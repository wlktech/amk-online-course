  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php if(isset($_SESSION['expire'])){
            ...
            ?>
        <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fas fa-plus me-2"></i>Create Category</h1>
      ...
      <form action="../src/Libs/controllers/CategoryController.php" method="post">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success"><i class="fas fa-plus-circle me-2"></i>Create Category</button>
        </div>
      </form>
    </div>
  </div>
